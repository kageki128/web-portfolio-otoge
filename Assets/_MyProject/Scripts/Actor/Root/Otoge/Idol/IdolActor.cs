...
namespace MyProject.Actor
{
    ...
    {
        const float ScrollSpeedMultiplierValue = 2.2f;
        ...
        [SerializeField] IdolHoldTickActor holdTickPrefab;
        ...
        public override void InstallActions(OtogeActions otogeActions)
        {
            ...
            ActionsObserver = idolActionsObserver;
        ...
        public override void Initialize()
        {
            ...
            idolActionsObserver.LanePressed.Subscribe(lane => laneKeysActor.LightUpLane(lane)).AddTo(this);
            idolActionsObserver.LaneReleased.Subscribe(lane => laneLightActor.LightDown(lane)).AddTo(this);
            idolActionsObserver.LaneReleased.Subscribe(lane => laneKeysActor.LightDownLane(lane)).AddTo(this);
